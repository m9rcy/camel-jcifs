...
/**
 * Unit test to consume from an empty org.apache.camel.component.jcifs.smb folder Verify that we catch NPE for
...
public class FromSmbEmptyFolderTest extends BaseSmbTestSupport {
    ...
    class FakeSmbFile extends SmbFile {
        ...
        public SmbFile[] listFiles() throws SmbException {
            ...
            // jcifs.org.apache.camel.component.jcifs.smb.Dfs.resolve(Dfs.java:169)
            ...
            newStackTrace[0] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.Dfs", "resolve", "Dfs.java", 169);
            newStackTrace[1] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "resolveDfs", "SmbFile.java", 671);
            newStackTrace[2] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "send", "SmbFile.java", 773);
            newStackTrace[3] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "doFindFirstNext", "SmbFile.java", 1986);
            newStackTrace[4] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "doEnum", "SmbFile.java", 1738);
            newStackTrace[5] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "listFiles", "SmbFile.java", 1715);
            newStackTrace[6] = new StackTraceElement("jcifs.org.apache.camel.component.jcifs.smb.SmbFile", "listFiles", "SmbFile.java", 1648);
