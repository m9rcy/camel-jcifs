 ...
 ***************************************************************************************/
package org.apache.camel.component.jcifs.strategy;
...
public class SmbChangedExclusiveReadLockStrategy implements GenericFileExclusiveReadLockStrategy<SmbFile> {
    ...
    public boolean acquireExclusiveReadLock(final GenericFileOperations<SmbFile> operations, final GenericFile<SmbFile> file, final Exchange exchange) throws Exception {
        ...
        while (!exclusive) {
            ...
            // fast option not available (org.apache.camel.component.jcifs.smb listFiles only handles directories), so list the directory and filter the file name
    ...
    public void setMarkerFiler(final boolean markerFiler) {
        // noop - not supported by org.apache.camel.component.jcifs.smb
    }
