  ...
  public List<SmbFile> listFiles(final String url) throws IOException {
    ...
    try {
      ...
      if (elements != null && elements.length > 0 && elements[0] != null
          && "jcifs.org.apache.camel.component.jcifs.smb.Dfs".equals(elements[0].getClassName())
          && "resolve".equals(elements[0].getMethodName())) {
        LOGGER.warn("Ignoring NPE in jcifs.org.apache.camel.component.jcifs.smb.Dfs.resolve: {}",
            ex.getMessage());
      } else {
        throw ex;
      }
